...
<!--            </svg>-->
        ...
        <div class="col-12 mt-4 mt-lg-5" style="font-size: 20px">Уважаемые участники Олимпиады! Если у вас не открывается сертификат, обратитесь в техническую поддержку.</div>
